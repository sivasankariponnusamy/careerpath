...
SKILL_ALIASES = {
    ...
    'C': [r'\bc programming\b', r'\b(?:language )?c\b(?!\+\+|#|ss|ss)'],
    'C++': [r'c\+\+', r'\bcpp\b'],
    'C#': [r'c#', r'\bcsharp\b', r'\.net\b'],
    ...
    'R': [r'\br programming\b', r'\bprogramming in r\b', r'\br language\b'],
    # Web
    'React': [r'\breact\.?js\b', r'\breactjs\b', r'\breact\b'],
    'Angular': [r'\bangular\b'],
    'Vue': [r'\bvue\.?js\b', r'\bvuejs\b'],
    'HTML': [r'\bhtml5?\b'],
    'CSS': [r'\bcss3?\b', r'\bsass\b', r'\bless\b'],
    ...
    'REST API': [r'\brest api\b', r'\brestful api\b', r'\brestful\b', r'\bapi development\b'],
    'WebSocket': [r'\bwebsocket\b', r'\bsocket\.?io\b'],
    # Databases
    'MongoDB': [r'\bmongodb\b', r'\bmongo\b'],
    'PostgreSQL': [r'\bpostgresql\b', r'\bpostgres\b'],
    'MySQL': [r'\bmysql\b'],
    'SQLite': [r'\bsqlite\b'],
    'SQL': [r'\bsql\b', r'\brelational database\b', r'\brdbms\b'],
    'NoSQL': [r'\bnosql\b'],
    'Redis': [r'\bredis\b'],
    'Cassandra': [r'\bcassandra\b'],
    'Oracle': [r'\boracle(?: database)?\b'],
    ...
    'Kubernetes': [r'\bkubernetes\b', r'\bk8s\b', r'\bcontainer orchestration\b'],
    'AWS': [r'\baws\b', r'\bamazon web services\b'],
    'Azure': [r'\bazure\b', r'\bmicrosoft azure\b'],
    'GCP': [r'\bgcp\b', r'\bgoogle cloud\b'],
    'CI/CD': [r'\bci/cd\b', r'\bcicd\b', r'\bcontinuous integration\b', r'\bcontinuous deployment\b', r'\bcontinuous delivery\b'],
    'Jenkins': [r'\bjenkins\b'],
    'GitHub Actions': [r'\bgithub actions\b'],
    'Git': [r'\bgit\b', r'\bgithub\b', r'\bgitlab\b', r'\bbitbucket\b', r'\bversion control\b'],
    'Linux': [r'\blinux\b', r'\bunix\b', r'\bubuntu\b', r'\bcentos\b', r'\bdebian\b'],
    'Nginx': [r'\bnginx\b'],
    'Terraform': [r'\bterraform\b'],
    'Ansible': [r'\bansible\b'],
    'EC2': [r'\bec2\b'],
    'S3': [r'\bamazon s3\b', r'\bs3 bucket\b'],
    'Lambda': [r'\baws lambda\b'],
    # ML / AI
    'Machine Learning': [r'\bmachine learning\b', r'\bml model\b', r'\bml algorithms?\b'],
    'Deep Learning': [r'\bdeep learning\b', r'\bneural network\b'],
    'TensorFlow': [r'\btensorflow\b'],
    'PyTorch': [r'\bpytorch\b'],
    'Scikit-learn': [r'\bscikit.?learn\b', r'\bsklearn\b'],
    'NLP': [r'\bnlp\b', r'\bnatural language processing\b', r'\btext classification\b', r'\bsentiment analysis\b'],
    ...
    'Data Analysis': [r'\bdata analysis\b', r'\bdata analytics\b', r'\bexploratory data analysis\b', r'\beda\b'],
    'PowerBI': [r'\bpower.?bi\b'],
    'Tableau': [r'\btableau\b'],
    'Excel': [r'\bexcel\b', r'\bms excel\b', r'\badvanced excel\b'],
    'Apache Spark': [r'\bapache spark\b', r'\bpyspark\b', r'\bspark\b'],
    'Kafka': [r'\bkafka\b'],
    'Airflow': [r'\bairflow\b', r'\bapache airflow\b'],
    # Mobile
    'Android': [r'\bandroid\b', r'\bandroid development\b', r'\bandroid sdk\b'],
    'iOS': [r'\bios development\b', r'\bios app\b', r'\bxcode\b'],
    'React Native': [r'\breact native\b'],
    'Flutter': [r'\bflutter\b'],
    # Design
    'Figma': [r'\bfigma\b'],
    'Adobe XD': [r'\badobe xd\b'],
    'UI/UX': [r'\bui/ux\b', r'\bux design\b', r'\buser experience\b', r'\buser interface\b', r'\bui design\b'],
    'Wireframing': [r'\bwireframing\b', r'\bwireframe\b', r'\bprototyping\b'],
    # Practices
    'Agile': [r'\bagile\b', r'\bscrum master\b'],
    'Scrum': [r'\bscrum\b'],
    'Jira': [r'\bjira\b'],
    ...
    'Cybersecurity': [r'\bcybersecurity\b', r'\bcyber security\b', r'\bnetwork security\b', r'\bpenetration testing\b'],
    ...
    'Unit Testing': [r'\bunit test\b', r'\bunittest\b', r'\btdd\b'],
    # Soft skills & fundamentals
    'Problem Solving': [r'\bproblem.?solving\b', r'\balgorithm\b', r'\bdata structures?\b', r'\bdsa\b'],
    ...
    'OOP': [r'\boop\b', r'\bobject.?oriented\b', r'\bobject oriented programming\b'],
    'Data Structures': [r'\bdata structures?\b', r'\blinked list\b', r'\bbinary tree\b', r'\bgraph\b'],
}

SKILL_CATEGORIES = {
    'Programming Languages': ['Python','JavaScript','TypeScript','Java','C','C++','C#','Go','Rust','PHP','Ruby','Swift','Kotlin','Scala','Dart','Bash','R'],
    'Web Technologies': ['React','Angular','Vue','HTML','CSS','Node.js','Express','Flask','Django','FastAPI','Spring Boot','Spring','Next.js','Nuxt.js','Redux','Tailwind','Bootstrap','jQuery','GraphQL','REST API','WebSocket'],
    ...
    'AI & Machine Learning': ['Machine Learning','Deep Learning','TensorFlow','PyTorch','Scikit-learn','NLP','Computer Vision','OpenCV','LangChain','OpenAI','HuggingFace','BERT'],
    'Data & Analytics': ['Pandas','NumPy','Matplotlib','Seaborn','Jupyter','Data Analysis','PowerBI','Tableau','Excel','Apache Spark','Kafka','Airflow'],
    'Mobile': ['Android','iOS','React Native','Flutter'],
    'Design': ['Figma','Adobe XD','UI/UX','Wireframing'],
    'Practices & Tools': ['Agile','Scrum','Jira','Project Management','Microservices','JWT','OAuth','Jest','Pytest','Selenium','Cypress','Unit Testing','Blockchain','Cybersecurity'],
    'Fundamentals': ['OOP','Data Structures','Problem Solving'],
    'Soft Skills': ['Teamwork','Communication','Leadership'],
}

# Weighted role scoring: higher weight = stronger signal for that role
ROLE_KEYWORDS = {
    'Frontend Developer':        {'react':4,'angular':4,'vue':4,'html':3,'css':3,'javascript':3,'typescript':2,'tailwind':2,'next.js':3,'redux':2,'bootstrap':1,'jquery':1,'figma':1},
    'Backend Developer':         {'python':2,'java':2,'node.js':3,'flask':4,'django':4,'fastapi':4,'spring boot':4,'postgresql':3,'mysql':3,'rest api':3,'mongodb':2,'redis':2,'c#':2},
    'Full Stack Developer':      {'react':3,'node.js':3,'javascript':2,'python':2,'mongodb':2,'postgresql':2,'html':2,'css':2,'express':3,'next.js':2,'rest api':2},
    'Data Scientist':            {'python':3,'machine learning':4,'pandas':4,'numpy':4,'scikit-learn':4,'tensorflow':3,'pytorch':3,'data analysis':4,'jupyter':3,'matplotlib':3,'seaborn':3,'r':2,'statistics':2},
    'Machine Learning Engineer': {'machine learning':4,'deep learning':4,'tensorflow':4,'pytorch':4,'scikit-learn':3,'nlp':3,'computer vision':3,'python':3,'huggingface':3,'bert':3,'langchain':3,'openai':2},
    'DevOps Engineer':           {'docker':4,'kubernetes':4,'aws':3,'azure':3,'ci/cd':4,'linux':3,'terraform':4,'ansible':3,'jenkins':3,'gcp':2},
    'Cloud Engineer':            {'aws':4,'azure':4,'gcp':4,'docker':3,'kubernetes':3,'terraform':3,'ec2':3,'s3':3,'lambda':3},
    'Data Engineer':             {'python':2,'apache spark':4,'kafka':4,'airflow':4,'sql':3,'aws':2,'data analysis':2,'pandas':3,'postgresql':2},
    'Mobile Developer':          {'android':4,'ios':4,'react native':4,'flutter':4,'swift':4,'kotlin':4,'dart':3},
    'UI/UX Designer':            {'figma':4,'adobe xd':4,'ui/ux':4,'wireframing':4,'css':2,'user experience':3},
    'Blockchain Developer':      {'blockchain':4,'solidity':4,'web3':3,'javascript':1,'python':1},
...
def read_file_content(file):
    ...
    if filename.endswith('.pdf'):
        try:
            ...
            if not text.strip():
                return None, "PDF appears scanned/image-based. Please upload a text-based PDF or .txt file."
            return text, None
